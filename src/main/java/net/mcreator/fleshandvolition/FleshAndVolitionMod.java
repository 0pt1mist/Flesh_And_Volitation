package net.mcreator.fleshandvolition;
...
@Mod("flesh_and_volition")
public class FleshAndVolitionMod {
	public static final Logger LOGGER = LogManager.getLogger(FleshAndVolitionMod.class);
	public static final String MODID = "flesh_and_volition";

	public FleshAndVolitionMod(IEventBus modEventBus) {
